// * what is function 
// A function is a reusable block of code that performs a specific task. It can take inputs (parameters), execute a series of statements, and return an output. Functions help in organizing code, improving readability, and reducing redundancy.
...
// let arrow = (...num1) =>{    // * spread operator
...
// let x = 10; // onece remove both and see
...
//     console.log(args2);
// }
// abc(arr); // going as a single args ie array
// abc(...arr); // calling like this abc(1,2,3,4,5,...);
